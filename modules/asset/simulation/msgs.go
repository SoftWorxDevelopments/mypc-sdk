...
import (
	...
	simulation2 "github.com/SoftWorxDevelopments/mypc-sdk/simulation"
)
...
func randomToken(r *rand.Rand, ctx sdk.Context, k asset.Keeper) asset.Token {
	...
	return tokenList[simulation2.GetRandomElemInmyposchain(r, len(tokenList))]
}
...
func randomSubsliceOfAddr(r *rand.Rand, addrs []sdk.AccAddress) []sdk.AccAddress {
	...
	for i := 0; i < randLen; i = i + 1 {
		returnList = append(returnList, addrs[simulation2.GetRandomElemInmyposchain(r, len(addrs))])
	}
	return returnList
}
