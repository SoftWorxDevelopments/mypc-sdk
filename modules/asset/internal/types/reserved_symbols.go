...
// only myposmyposchain owner can issue reserved symbol token
...
var reserved = []string{
	...
	"ada", "cmt", "cody", "nano", "zrx", "hydro", "trx", "mypc", "seele", "doge",
	...
	// extra currency
	"libra", "mypc", "rmb", "dcep", "mypos", "viabtc", "matrix", "bitmain",
}
