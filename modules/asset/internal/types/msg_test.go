...
func TestMsgTransferOwnership_ValidateBasic(t *testing.T) {
	var addr, _ = sdk.AccAddressFromBech32("mypos1e9kx6klg6z9p9ea4ehqmypl6dvjrp96vfxecd5")
	tests := []struct {
		name string
...
func TestMsg_GetSignBytes(t *testing.T) {
	var owner, _ = sdk.AccAddressFromBech32("mypos15fvnexrvsm9ryw3nn4mcrnqyhvhazkkrd4aqvd")
	var addr, _ = sdk.AccAddressFromBech32("mypos1e9kx6klg6z9p9ea4ehqmypl6dvjrp96vfxecd5")

	var addr1, _ = sdk.AccAddressFromBech32("mypos1y5kdxnzn2tfwayyntf2n28q8q2s80mcul852ke")
	var addr2, _ = sdk.AccAddressFromBech32("mypos133w8vwj73s4h2uynqft9gyyy52cr6rg8dskv3h")
	...
	tests := []struct {
	...
	}{
		{
			...
			NewMsgIssueToken("ABC Token", "abc", sdk.NewInt(10000), owner,
				false, false, false, false, "", "", TestIdentityString),
			`{"type":"asset/MsgIssueToken","value":{"addr_forbiddable":false,"burnable":false,"description":"","identity":"552A83BA62F9B1F8","mintable":false,"name":"ABC Token","owner":"mypos15fvnexrvsm9ryw3nn4mcrnqyhvhazkkrd4aqvd","symbol":"abc","token_forbiddable":false,"total_supply":"10000","url":""}}`,
		},
		{
			"transfer-ownership",
			NewMsgTransferOwnership("abc", owner, addr),
			`{"type":"asset/MsgTransferOwnership","value":{"new_owner":"mypos1e9kx6klg6z9p9ea4ehqmypl6dvjrp96vfxecd5","original_owner":"mypos15fvnexrvsm9ryw3nn4mcrnqyhvhazkkrd4aqvd","symbol":"abc"}}`,
		},
		{
			"burn-token",
			NewMsgBurnToken("abc", sdk.NewInt(10000), owner),
			`{"type":"asset/MsgBurnToken","value":{"amount":"10000","owner_address":"mypos15fvnexrvsm9ryw3nn4mcrnqyhvhazkkrd4aqvd","symbol":"abc"}}`,
		},
		{
			"mint-token",
			NewMsgMintToken("abc", sdk.NewInt(10000), owner),
			`{"type":"asset/MsgMintToken","value":{"amount":"10000","owner_address":"mypos15fvnexrvsm9ryw3nn4mcrnqyhvhazkkrd4aqvd","symbol":"abc"}}`,
		},
		{
			"forbid-token",
			NewMsgForbidToken("abc", owner),
			`{"type":"asset/MsgForbidToken","value":{"owner_address":"mypos15fvnexrvsm9ryw3nn4mcrnqyhvhazkkrd4aqvd","symbol":"abc"}}`,
		},
		{
			"unforbid-token",
			NewMsgUnForbidToken("abc", owner),
			`{"type":"asset/MsgUnForbidToken","value":{"owner_address":"mypos15fvnexrvsm9ryw3nn4mcrnqyhvhazkkrd4aqvd","symbol":"abc"}}`,
		},
		{
			"add_token_whitelist",
			NewMsgAddTokenWhitelist("abc", owner, addrList),
			`{"type":"asset/MsgAddTokenWhitelist","value":{"owner_address":"mypos15fvnexrvsm9ryw3nn4mcrnqyhvhazkkrd4aqvd","symbol":"abc","whitelist":["mypos1y5kdxnzn2tfwayyntf2n28q8q2s80mcul852ke","mypos133w8vwj73s4h2uynqft9gyyy52cr6rg8dskv3h"]}}`,
		},
		{
			"remove-token-whitelist",
			NewMsgRemoveTokenWhitelist("abc", owner, addrList),
			`{"type":"asset/MsgRemoveTokenWhitelist","value":{"owner_address":"mypos15fvnexrvsm9ryw3nn4mcrnqyhvhazkkrd4aqvd","symbol":"abc","whitelist":["mypos1y5kdxnzn2tfwayyntf2n28q8q2s80mcul852ke","mypos133w8vwj73s4h2uynqft9gyyy52cr6rg8dskv3h"]}}`,
		},
		{
			"forbid-addr",
			NewMsgForbidAddr("abc", owner, addrList),
			`{"type":"asset/MsgForbidAddr","value":{"addresses":["mypos1y5kdxnzn2tfwayyntf2n28q8q2s80mcul852ke","mypos133w8vwj73s4h2uynqft9gyyy52cr6rg8dskv3h"],"owner_address":"mypos15fvnexrvsm9ryw3nn4mcrnqyhvhazkkrd4aqvd","symbol":"abc"}}`,
		},
		{
			"unforbid-addr",
			NewMsgUnForbidAddr("abc", owner, addrList),
			`{"type":"asset/MsgUnForbidAddr","value":{"addresses":["mypos1y5kdxnzn2tfwayyntf2n28q8q2s80mcul852ke","mypos133w8vwj73s4h2uynqft9gyyy52cr6rg8dskv3h"],"owner_address":"mypos15fvnexrvsm9ryw3nn4mcrnqyhvhazkkrd4aqvd","symbol":"abc"}}`,
		},
		{
			"modify-token-info",
			NewMsgModifyTokenInfo("abc", "www.abc.com", "abc example description", TestIdentityString, owner,
				"ABC token", "1000", "true", "true", "true", "true"),
			`{"type":"asset/MsgModifyTokenInfo","value":{"addr_forbiddable":"true","burnable":"true","description":"abc example description","identity":"552A83BA62F9B1F8","mintable":"true","name":"ABC token","owner_address":"mypos15fvnexrvsm9ryw3nn4mcrnqyhvhazkkrd4aqvd","symbol":"abc","token_forbiddable":"true","total_supply":"1000","url":"www.abc.com"}}`,
		},
	}
