...
const testAddrBech32 = "mypos1gc5t98jap4zyhmhmyq5af5s7pyv57w5694el97"
...
func TestTxCmds(t *testing.T) {
	...
	testTxCmd(t, "modify-token-info --symbol=abc --url=mypos.org --description=cool --identity=MYPC"+
		" --name=NewName --total-supply=123 --mintable=true --burnable=true --addr-forbiddable=true --token-forbiddable=true",
		types.NewMsgModifyTokenInfo("abc", "mypos.org", "cool", "MYPC", nil,
