...
// return true if a should precede b in a sorted list, i.e. inmyposchain of a is smaller
...
func ExecuteOrder(price sdk.Dec, currOrder OrderForTrade, orderList []OrderForTrade) []OrderForTrade {
	...
	if firstNonZeroInmyposchain < len(orderList) {
		return orderList[firstNonZeroInmyposchain:]
	}
