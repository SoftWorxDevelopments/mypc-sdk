...
var unitChainID = "mypos-myposchain"
...
func TestOrderCleanUpDayKeeper(t *testing.T) {
	ctx, keys := newContextAndMarketKey("mypos-chain")
...
func newKeeperForTest(key sdk.StoreKey) OrderKeeper {
	return NewOrderKeeper(key, "mypc/usdt", types.ModuleCdc)
}
