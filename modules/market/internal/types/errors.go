...
const (
	...
	CodeNotListedAgainstMypc    sdk.CodeType = 621
...
func ErrNotListedAgainstMypc(stock string) sdk.Error {
	return sdk.NewError(CodeSpaceMarket, CodeNotListedAgainstMypc, "The stock(%s) not have mypc trade", stock)
}
