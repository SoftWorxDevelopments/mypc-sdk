...
func TestQuery(t *testing.T) {
	...
	assert.Equal(t, keepers.QueryMarketParam{TradingPair: "eth/mypc"}, ResultParam)
	...
	cmd.SetArgs(args)
	err = cmd.Execute()
	assert.Equal(t, "trading-pair illegal : eth-mypc, For example : eth/mypc.", err.Error())
	assert.Equal(t, "custom/market/market-info", ResultPath)
