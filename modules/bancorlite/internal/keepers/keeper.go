...
func (keeper Keeper) IsBancorExist(ctx sdk.Context, stock string) bool {
	...
	key := append(BancorInfoKey, []byte(stock+myposchain.SymbolSeparator)...)
...
func (keeper *Keeper) DeductInt64MypcFee(ctx sdk.Context, addr sdk.AccAddress, amt int64) sdk.Error {
	return keeper.bxk.DeductInt64MypcFee(ctx, addr, amt)
}
