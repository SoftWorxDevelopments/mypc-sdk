...
func InitStates(ctx sdk.Context, sxk Keeper, ak auth.AccountKeeper, splk supply.Keeper) MockKeeper {
	...
	params.BondDenom = "mypc"
	sxk.sk.SetParams(ctx, params)

	//initialize FeePool
	feePool := types.FeePool{
		CommunityPool: sdk.NewDecCoins(myposchain.NewMypcCoins(0)),
	}
	...
	splk.SetSupply(ctx, supply.Supply{Total: sdk.Coins{sdk.NewInt64Coin("mypc", 10e8)}})
	return MockKeeper{
		sxk,
		sxk.sk,
		sxk.dk,
