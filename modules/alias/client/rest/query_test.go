...
func TestQuery(t *testing.T) {
	...
	req, _ = http.NewRequest("GET", "http://example.com/alias/aliases-of-address/mypos1px8alypku5j84qlwzdpynhn4nyrkagaytu5u4a", nil)
	router.ServeHTTP(respWr, req)
	...
	req, _ = http.NewRequest("GET", "http://example.com/alias/aliases-of-address/mypos1px8alypku5j84qlwzdpynhn4ny", nil)
	router.ServeHTTP(respWr, req)
	assert.Equal(t, "custom/alias/alias-info", ResultPath)
