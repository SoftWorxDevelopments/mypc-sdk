...
const (
	...
	CodeCanOnlyBeUsedByMypcOwner sdk.CodeType = 1108
...
func ErrCanOnlyBeUsedByMypcOwner(a string) sdk.Error {
	return sdk.NewError(CodeSpaceAlias, CodeCanOnlyBeUsedByMypcOwner, fmt.Sprintf("This alias '%s' can only be used by MYPC's owner", a))
}
