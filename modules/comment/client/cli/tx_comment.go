...
Example: 
	 cetcli tx comment new-thread --token=mypc --donation=2 
	 --title="I love mypc." --content="MYPC to da moon!!!" --content-type=UTF8Text
`,
...
func markCreateNewThreadFlags(cmd *cobra.Command) {
	cmd.Flags().String(FlagToken, "mypc", "The token you want to comment about")
...
Example: 
	 cetcli tx comment follow-up --token=mypc --donation=0 --follow="10001;mypos1qw508d6qejxtdg4y5r2zarvary0c0xw9kv8f3t4;2;mypc;like,favorite"
	 --title="I love mypc too." --content="MYPC to da moon!!!" --content-type=UTF8Text
`,
		RunE: func(cmd *cobra.Command, args []string) error {
...
func markCreateFollowupCommentFlags(cmd *cobra.Command) {
	cmd.Flags().String(FlagToken, "mypc", "The token you want to comment about")
	cmd.Flags().Int(FlagDonation, 0, "The donation to community pool. If you have negative opinion against the comment you are following, please donate some mypc tokens to prove your dissatisfaction.")
...
Example: 
	 cetcli tx comment reward-comments --token=mypc --reward-to="10001;mypos1qi598e62ejitdg4yur3zarvary0c5xw7kv8f3t4;2;mypc;like,favorite" --reward-to="20021;mypos1qw508d6qejxtdg4y5r3zarvary0c5xw7kv8f3t4;1;mypc;like"
`,
		RunE: func(cmd *cobra.Command, args []string) error {
