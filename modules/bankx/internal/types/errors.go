...
const (
	...
	CodeInsufficientMYPCForActivationFee sdk.CodeType = 302
...
func ErrInsufficientMYPCForActivatingFee() sdk.Error {
	return sdk.NewError(CodeSpaceBankx, CodeInsufficientMYPCForActivationFee, "Insufficient MYPC for Activating fees")
}
