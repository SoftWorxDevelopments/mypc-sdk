...
var (
	...
	ErrInsufficientMYPCForActivatingFee = types.ErrInsufficientMYPCForActivatingFee

	// variable aliases

	ModuleCdc                           = types.ModuleCdc
	CodeMemoMissing                     = types.CodeMemoMissing
	CodeInsufficientMYPCForActivatingFee = types.CodeInsufficientMYPCForActivationFee
)
