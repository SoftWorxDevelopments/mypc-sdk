...
func RandomMYPC(r *rand.Rand, ctx sdk.Context, ak auth.AccountKeeper, fromAcc simulation.Account) (donation int64) {

	fromCoins := ak.GetAccount(ctx, fromAcc.Address).GetCoins().AmountOf(myposchain.DefaultBondDenom)
	if !fromCoins.IsZero() {
...
func GetRandomElemInmyposchain(r *rand.Rand, length int) int {
